...
def save_excel_outputs(*args, **kwargs) -> bytes:
    ...
    if args:
        ...
        # ignore extra positionals leniently
    ...
    with log_time(log, "save_excel_outputs"):
        ...
        with pd.ExcelWriter(buf, engine="xlsxwriter") as xw:
            try:
                ...
                pass  # some engines/templates may not support set_properties

            # Always write a sheet if a DataFrame object was provided (even if empty)
...
# Part II (Monthly Line 14 and Line 16) – adjust IDs if your template differs
LINE14_MONTH_FIELDS = {
...
def fill_pdf_for_employee(*args, **kwargs) -> Tuple[bytes, Optional[bytes]]:
    ...
    Keyword args supported:
      ...
      employee_pi: Dict[str,str]  # {'first_name','middle_name','last_name','ssn','address1','address2','city','state','zip'}
      line14_by_month: Dict[int,str]  # {1:'1E',...,12:'1H'}
      line16_by_month: Dict[int,str]  # {1:'2C',...,12:'2A'}
